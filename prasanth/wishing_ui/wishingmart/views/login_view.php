                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-7 text">
                            <h1>Log In <strong>Wishing Mart</strong> Password</h1>
                        ...
                        <div class="col-sm-5 form-box">
                            <div class="form-top">
                                <div class="form-top-left">
                                    <h3>Sign In</h3>
                                    <p>Enter the email address and password to buy or sell on <strong>Wishing Mart</strong></p>
                                </div>
                            ...
                            <div class="form-bottom">
                                <form role="form" action="" method="post" class="registration-form">
                                    ...
                                    <a href="<?php echo base_url('index.php/reset/resetpassword'); ?>">Forgot Password?</a>
