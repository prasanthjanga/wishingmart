...
<?php  }// if end  ?>  
<?php if($title =="Sales" || $title =="Reports"){ ?>
    <script type="text/javascript">
    //Date range picker
...
<?php  }// if end  ?>  
    <!-- ChartJS 1.0.1 -->
    <script src="<?php echo base_url('asserts/plugins/chartjs/Chart.min.js'); ?>" type="text/javascript"></script>
    <!-- FastClick -->
    <script src='<?php echo base_url('asserts/plugins/fastclick/fastclick.min.js'); ?>' type="text/javascript" ></script>
