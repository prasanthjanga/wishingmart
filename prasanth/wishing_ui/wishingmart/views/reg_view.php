                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-7 text">
                            <h1><strong>Wishing Mart</strong> Registration Form</h1>
                        ...
                        <div class="col-sm-5 form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="" method="post" class="registration-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-email">Email</label>
                                        <input type="text" name="form-email" placeholder="Re-enter Email..." class="form-email form-control" id="form-email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-email">I am</label>
                                        <select class="form-select form-control" id="form-select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" Placeholder="Select DOB">
                                    </div>
