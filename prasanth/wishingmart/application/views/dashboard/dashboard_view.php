  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="box box-info">
            ...
            <table class="table no-margin">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="invoice.html" class="btn btn-danger">View Invoice</a></td>
                </tr>
                <tr>
        ...
        <div class="box-footer clearfix">
          <a href="ProfileInvoices.html" class="btn btn-sm btn-danger pull-right">View All Transactions</a>
        </div><!-- /.box-footer -->
      </div><!-- /.box -->
      ...
      <div class="box box-info">
            ...
            <table class="table no-margin">
              ...
              <tbody>
                ...
                <img src="<?php echo base_url('assets/images/products/pic.jpg'); ?>" alt="Product Image" />
                  ...
                  <td>01/12/2014</td>
                  <td><a href="UpdateWish.html" class="btn btn-danger">Update Wish</a></td>
        ...
        <div class="box-footer clearfix">
          <a href="javascript::;" class="btn btn-sm btn-danger pull-right">View All Wishes</a>
        </div><!-- /.box-footer -->
      </div><!-- /.box -->
   ...
   <!-- TABLE: GRANT REQUEST -->
      <div class="box box-info">
        ...
        <div class="box-footer clearfix">
          <a href="ProfileGrant.html" class="btn btn-sm btn-danger pull-right">View All Requests</a>
        </div><!-- /.box-footer -->
      </div><!-- /.box -->
   </section>
   </div>